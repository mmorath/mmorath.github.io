...
install: ## Install the docs toolchain (mkdocs-material + i18n + glightbox) via pip
	@printf "$(CYAN)Installing mkdocs-material + mkdocs-static-i18n + mkdocs-glightbox$(RESET)\n"
